  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        subjectEnrollment: 'Enrollment Inquiry',
        subjectVolunteering: 'Volunteering',
        subjectDonation: 'Donation',
        subjectOther: 'Other',
    ...
    footer: {
      about: 'About',
      aboutDescription: 'Music and English education united with spiritual growth through Christian faith.',
      quickLinks: 'Quick Links',
      aboutUs: 'About Us',
      ministries: 'Ministries',
      getInvolved: 'Get Involved',
  ...
  es: {
    ...
    contact: {
      ...
      form: {
        ...
        subjectEnrollment: 'Consulta de Inscripción',
        subjectVolunteering: 'Voluntariado',
        subjectDonation: 'Donación',
        subjectOther: 'Otro',
        message: 'Mensaje',
    ...
    footer: {
      about: 'Acerca de',
      aboutDescription: 'Educación musical e inglés unidos con crecimiento espiritual a través de la fe cristiana.',
      quickLinks: 'Enlaces Rápidos',
