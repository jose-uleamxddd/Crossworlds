...
export default function HeroWithBackground() {
  return (
    <section className="relative bg-gradient-to-br from-[#0b5298] via-[#0d63b8] to-[#093f72] py-20 md:py-32 overflow-hidden">
        ...
        <div className="text-center space-y-8 animate-fade-in-up">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 text-balance">
              Academia de música e inglés
            </h1>
            <p className="text-xl md:text-2xl text-white/90 text-balance max-w-3xl mx-auto">
              Aprende música e inglés mientras creces en la fe. Crossworlds Connection
              combina excelencia académica con valores cristianos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/20">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">Ministerios Activos</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-white">15+</p>
              <p className="text-sm text-white/80">Años de Servicio</p>
            </div>
          </div>
        </div>
      </div>
